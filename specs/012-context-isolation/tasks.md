...
- [X] T001 [P] [US1] Add context clear recommendation after plan review in spex/overlays/superpowers/commands/speckit.plan.append.md
- [X] T002 [P] [US1] Add context clear recommendation after implementation in spex/overlays/superpowers/commands/speckit.implement.append.md
- [X] T003 [P] [US2] Update spec selection to use branch-based resolution in spex/skills/review-code/SKILL.md
- [X] T004 [P] [US2] Update spec selection to use branch-based resolution in spex/skills/review-spec/SKILL.md
- [X] T005 [P] [US2] Update spec selection to use branch-based resolution in spex/skills/deep-review/SKILL.md
- [X] T006 [P] [US2] Update spec selection to use branch-based resolution in spex/skills/verification-before-completion/SKILL.md
...
- [X] T008 [US3] Restructure ship skill stage 6 (implement) to use Agent tool with isolation in spex/skills/ship/SKILL.md
- [X] T009 [US3] Restructure ship skill stage 7 (review-code) to use Agent tool with isolation in spex/skills/ship/SKILL.md
- [X] T010 [US3] Update ship skill handoff mechanism: pass spec/plan/tasks file paths as Agent prompt context in spex/skills/ship/SKILL.md
...
- [X] T012 [P] Update integration test to verify no regressions in tests/test_marketplace_install.sh
- [X] T013 [P] Update README.md with context isolation documentation
- [X] T014 [P] Update help text in spex/docs/help.md (if needed)
- [X] T015 Run `make release` to validate plugin
